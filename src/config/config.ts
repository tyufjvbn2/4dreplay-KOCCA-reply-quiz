...
export const config = {
	db: {
		production: `${process.env.MONGO_HOST}/${process.env.MONGO_DB}`,
		development: `${process.env.MONGO_HOST}/${process.env.MONGO_DB}_dev`,
		test: `${process.env.MONGO_HOST}/${process.env.MONGO_DB}_test`,
	},
};
